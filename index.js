...
client.on('message', message => {
  const guild = client.guilds.find(x => x.name === 'Minor Annoyance')
  const logChnl = guild.channels.find(x => x.name === 'chat-log')
  ...
  if (!message.author.bot && client.guilds.find(x => x.name === 'Minor Annoyance').id === message.guild.id) {
